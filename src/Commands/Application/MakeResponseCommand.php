...
{
    protected $signature = 'devcortes:response {module : The name of the module} {name : The name of the response}';

    protected $description = 'Create a new response within a module';
    ...
    public function handle(): int
    {
        ...
        $path = app_path("Src/Application/{$module}/Responses/{$name}.php");
        ...
        $stub = $this->files->get(__DIR__ . '/../../Stubs/application/response.stub');
